...
public enum CardNameType {
    ...
    MassiveExposePloy(CardType.Ploy, CardSubType.InstantPloy),
    MutualBenefitPloy(CardType.Ploy, CardSubType.InstantPloy),
    MassiveChainPloy(CardType.Ploy, CardSubType.InstantPloy),
    SendLimboPloy(CardType.Ploy, CardSubType.InstantPloy),
    MoreStagePloy(CardType.Ploy, CardSubType.InstantPloy),
